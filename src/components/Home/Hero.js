...
export default function Hero(props) {
	...
	return (
		<section id="home" className="section hero" ref={targetRef}>
			<motion.div className="sticky sticky-hero" style={{opacity}}>
				<motion.div
					...
					<AnimatedText text="Hi, I'm Lilian."></AnimatedText>
					<AnimatedText text="I'm a Front-end"></AnimatedText>
					<AnimatedText text="Developer."></AnimatedText>
				</motion.div>
				<motion.div
					ref={inViewRef}
